...
import { Lock, Mail, User, Shield, ArrowRight, Warehouse } from 'lucide-react';
import api from '../api';
...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-dark-bg p-4 overflow-hidden relative">
            ...
            <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-indigo-500/20 rounded-full blur-[100px] pointer-events-none" />
            ...
            >
                <div className="glass-card p-10 relative overflow-hidden group">
                    ...
                    <p className="text-slate-400 text-center mb-8">Join the Smart Inventory Platform</p>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-3 py-2.5 border border-slate-700 rounded-xl bg-slate-800/50 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all font-medium"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="block w-full pl-11 pr-3 py-2.5 border border-slate-700 rounded-xl bg-slate-800/50 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all font-medium appearance-none"
                                >
